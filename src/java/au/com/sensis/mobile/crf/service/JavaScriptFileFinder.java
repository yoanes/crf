...
/**
 * Simple interface for finding JavaScript files in a directory whilst
 * preserving the dependency order of those files.
 */
public interface JavaScriptFileFinder {

    /**
     * Find all JavaScript files in the given directory, sorted according to the
     * dependencies of the files.
     *
     * @param dir
